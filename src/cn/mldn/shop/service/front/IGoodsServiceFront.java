...
public interface IGoodsServiceFront {
	 ...
	 * <li>要调用IGoodsDAO.getAllCountByItem()方法查询出全部的数据量</li>
	 * <li>调用的时候status设置的内容为1，表示上架商品</li>
	 * @param iid
	 * @param currentPage
	 * @param lineSize
	 ...
	 * <li>key=goodsCount,value=IGoodsDAO.getAllCountByItem()，保存的是Integer</li>	 * @throws Exception
	 */
